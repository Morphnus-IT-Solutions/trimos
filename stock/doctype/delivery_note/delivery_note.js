...
cur_frm.cscript.onload = function(doc, dt, dn) {
  ...
  if(doc.__islocal){
    hide_field(['customer_address','contact_person','customer_name','address_display','contact_display','contact_mobile','contact_email','territory','customer_group', 'contact_department', 'contact_designation']);
  }   
...
cur_frm.cscript.refresh = function(doc, cdt, cdn) { 
  ...
  if(doc.docstatus == 1) cur_frm.add_custom_button('Make Installation Report', cur_frm.cscript['Make Installation Report']);
