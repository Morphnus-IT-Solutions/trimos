...
if not filter_values.get('fiscal_year1'):
  ...
  fiscal_year = filter_values.get('fiscal_year1')
...
res = [['Quotation'], ['Sales Order'], ['Delivery Note'], ['Service Quotation'], ['Service Order']]
